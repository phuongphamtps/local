...
using AngularBookService.Models;
using AngularBookService.Models.BookModels;
using AngularBookService.Models.BookServiceDTO;

namespace AngularBookService.Controllers.BookControllers
{
    public class BooksController : ApiController
    {
        private AngularBookServiceContext db = new AngularBookServiceContext();
